        ...
        <section class="mt-12 bg-gradient-to-r from-sri-lanka-blue to-blue-800 text-white rounded-lg p-8">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div>
                    ...
                    <p class="text-gray-200 mb-4">Tuk-tuks, taxis, and ride-hailing apps are convenient. Buses are
                        affordable but can be crowded.</p>

                    <h3 class="font-semibold mb-2">🛍️ Shopping Tips</h3>
                    <p class="text-gray-200">Bargain at markets like Pettah, but malls like Odel offer fixed-price
                        luxury goods.</p>
                </div>
                <div>
                    <h3 class="font-semibold mb-2">🌡️ Best Time to Visit</h3>
                    <p class="text-gray-200 mb-4">January to March is ideal for pleasant weather. Avoid heavy monsoon
                        rains from May to September.</p>

                    <h3 class="font-semibold mb-2">🎉 Events</h3>
                    <p class="text-gray-200">Experience the Colombo Art Biennale or local food festivals for a taste of
                        urban culture.</p>
                </div>
            </div>
        </section>
