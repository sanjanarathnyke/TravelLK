        ...
        <section class="mt-12">
            ...
            <div class="grid md:grid-cols-3 gap-6 px-4">
                @php
                    $attractions = [
                        [
                            'image' => 'assets/images/attractions/jaya-sri-maha-bodhi.jpg',
                            'title' => 'Jaya Sri Maha Bodhi',
                        ],
                        ['image' => 'assets/images/attractions/ruwanwelisaya.jpg', 'title' => 'Ruwanwelisaya Stupa'],
                        [
                            'image' => 'assets/images/attractions/jetavanaramaya.jpg',
                            'title' => 'Jetavanaramaya Monastery',
                        ],
                        ...
                        [
                            'image' => 'assets/images/attractions/ankurukaramaya.jpg',
                            'title' => 'Twin Ponds (Kuttam Pokuna)',
                        ],
                    ];
                @endphp
