...
<body class="bg-gray-50">
    ...
    <section class="relative bg-gradient-to-r from-sri-lanka-blue to-blue-800 text-white">
        ...
        <div class="absolute inset-0 bg-cover bg-center" style="background-image: url('/placeholder.svg?height=600&width=1200&text=Sri+Lanka+Landscape')"></div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                    <img src="{{ asset('assets/images/kandy/pexels-eugene-dorosh-230277-739409.jpg') }}" alt="Kandy" class="w-full h-48 object-cover">
                    <div class="p-6">
                        ...
                        <a href="{{ route('kandy') }}" class="text-sri-lanka-blue font-semibold hover:underline">Explore Kandy →</a>
                    </div>
                </div>
                
                <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                    <img src="{{ asset('assets/images/down-south/pexels-freestockpro-319948.jpg') }}" alt="Down South" class="w-full h-48 object-cover">
                    <div class="p-6">
                        ...
                        <a href="{{ route('down-south') }}" class="text-sri-lanka-blue font-semibold hover:underline">Explore South →</a>
                    </div>
                </div>
                
                <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                    <img src="{{ asset('assets/images/ella/pexels-freestockpro-321569.jpg') }}" alt="Ella" class="w-full h-48 object-cover">
                    <div class="p-6">
                        ...
                        <a href="{{ route('ella') }}" class="text-sri-lanka-blue font-semibold hover:underline">Explore Ella →</a>
                    </div>
                </div>
            </div>
            
            <div class="text-center mt-12">
                <a href="{{ route('regions') }}" class="inline-block bg-sri-lanka-blue text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-800 transition-colors">
                    View All Regions
                </a>
            </div>
        </div>
